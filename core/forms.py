...
class TaskForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['deadline'].widget.attrs.update({'class': 'form-control form-control-sm', 'type': 'datetime-local'})
        self.fields['label'].widget.attrs.update({'class': 'form-control form-control-sm', 'placeholder': 'Заголовок задачи'})
        self.fields['text'].widget.attrs.update({'class': 'form-control form-control-sm', 'placeholder': 'Содержание'})
